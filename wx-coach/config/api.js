...
module.exports = {
  ...
  //   CatalogCurrent: NewApiRootUrl + 'catalog/current',  //分类目录当前分类数据接口
    ...
    GoodsCount: NewApiRootUrl + 'goods/count',  //统计拼班总数
    GoodsList: NewApiRootUrl + 'goods/list',  //获得拼班列表
    // GoodsCategory: NewApiRootUrl + 'goods/category',  //获得分类数据
    GoodsDetail: NewApiRootUrl + 'goods/detail',  //获得拼班的详情
    ...
    // BrandList: NewApiRootUrl + 'brand/list',  //品列表
  ...
  //   FeedbackAdd: NewApiRootUrl + 'feedback/save', //添加反馈
    SmsCode: NewApiRootUrl + 'gbcoach/captcha', //发送短信
  ...
  gbCoachSave: NewApiRootUrl + 'gbcoach/save',  //申请成为教练
}; 
