...
//    }
     ...
     * 课程详情页数据
     */
    @ApiOperation(value = " 课程详情页数据")
    @ApiImplicitParams({@ApiImplicitParam(name = "id", value = "课程id", paramType = "path", required = true),
            @ApiImplicitParam(name = "referrer", value = "课程referrer", paramType = "path", required = false)})
