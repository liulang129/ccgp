$(function () {
    $("#jqGrid").Grid({
        ...
        colModel: [
            ...
            {label: '校区', name: 'brandName', index: 'brand_id', width: 120},
            {label: '班级名称', name: 'name', index: 'name', width: 160},
            {label: '教练', name: 'coachName', index: 'goods_sn', width: 80},
            // {
            ...
            {label: '课程类别', name: 'attributeCategoryName', index: 'attribute_category', width: 80},
            {label: '拼班状态', name: 'status', index: 'status', width: 80}]
    });
    $('#goodsDesc').editable({
        inlineMode: false,
        alwaysBlank: true,
