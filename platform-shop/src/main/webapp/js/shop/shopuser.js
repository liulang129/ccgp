$(function () {
    $("#jqGrid").Grid({
        url: '../user/list',
        colModel: [{
            label: '会员id', name: 'id', index: 'id', width: 60,key: true
        }, {
            label: '邀请人', name: 'promoterName', index: 'promoterName', width: 80
        },{
            ...
            label: '出生日期', name: 'birthday', index: 'birthday', width: 100, formatter: function (value) {
                return transDate(value);
            }
        }, {
            label: '注册时间', name: 'registerTime', index: 'register_time', width: 100, formatter: function (value) {
                return transDate(value);
            }
        }, {
            label: '是否实名认证', name: 'isReal', index: 'isReal', width: 80, formatter: function (value) {
                return value==2?'<span class="label label-success">已认证</span>':'<span class="label label-danger">未认证</span>';
            }
        }, {
        ...
        {
            label: '余额', name: 'allProfit', index: 'allProfit', width: 80, formatter: function (value) {
            return transYuan(value);
        }
        },
            {
